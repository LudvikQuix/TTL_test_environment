...
# test: upgrade onto the v7.5 store the genuine 3.23.6 seeder filled. The first
...
app = Application(
    consumer_group="dedup-filter-stable-v7.5",
    state_dir=STATE_DIR,
...
def dedup_filter(value, key, timestamp, headers, state):
    ...
    # First ttl= write on the populated v7.5 store flips the partition and
